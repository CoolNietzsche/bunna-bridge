...
export default function TopBar({ sidebarWidth }: TopBarProps) {
  ...
  const S = {
    header: {
      ...
      height: "56px", background: "rgba(44,24,16,0.95)",
    ...
    searchInput: {
      ...
      color: "#F5EDD8", fontFamily: "DM Mono, monospace", fontSize: "0.75rem",
      width: "100%",
    },
    iconBtn: {
    ...
    dropdown: {
      ...
      borderRadius: "4px", boxShadow: "0 20px 60px rgba(0,0,0,0.6)",
    ...
    <header style={S.header}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "4px", marginLeft: "auto" }}>
        ...
        <div style={{ position: "relative" }} ref={notifRef}>
          ...
          {notifOpen && (
            <div style={{ ...S.dropdown, width: "320px" }}>
        ...
        <div style={{ position: "relative" }} ref={profileRef}>
          <button style={S.profileBtn} onClick={() => { setProfile(o => !o); setNotif(false); }}>
            ...
            <span style={{ fontFamily: "DM Mono, monospace", fontSize: "0.72rem", color: "#F5EDD8" }}>
