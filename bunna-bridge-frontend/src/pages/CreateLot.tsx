...
export default function CreateLot() {
  ...
  const s = {
    ...
    stepper:  { display: "flex", gap: "0", marginBottom: "2.5rem", overflowX: "auto" as const, WebkitOverflowScrolling: "touch" as const },
    stepItem: (active: boolean, done: boolean) => ({
      flex: 1, padding: "0.75rem 1rem", fontFamily: "monospace",
      fontSize: "0.58rem", letterSpacing: "0.1em", whiteSpace: "nowrap" as const, textTransform: "uppercase" as const,
